...
//                   volume is too small to reliably cross an OS receive buffer. #246: total
//                   volume alone does not reliably force the drop — a slow, trickling
//                   producer (observed on CI's Windows runner) lets an actively-draining
//                   subscriber keep pace indefinitely no matter how much data eventually
//                   arrives. The fix is on the consumer side (delaying when it starts
//                   draining at all), not this fixture; this scenario's shape is unchanged.
